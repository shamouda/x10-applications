...
@Ifdef("__RECORD_LOOP_TIMES__") {
    ...
    public def this(opts:CommandLineOptions, placesPerSide:Int, places:PlaceGroup, team:Team) {
        this.places = places;
        this.team = team;
        this.opts = opts;
...
@Ifdef("__RECORD_LOOP_TIMES__") {
        ...
        if (reportCommTime) {
            ...
            Console.OUT.println();
            val labels = ["pos/vel_wait","pos/vel_process","pos/vel_send",
                          "force_wait","force_process","force_send",
                          "gradient_wait","gradient_process","gradient_send",
                          "all_reduce"];
